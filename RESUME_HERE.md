...
### ▶ STEP 3 — point **Wear** at the shared project → **SCOPED + DIRECTION LOCKED (2026-06-21); build NOT started**
...
[citizens-wear PR #22](https://github.com/citizensnetwork/citizens-wear/pull/22) (open, for founder merge).
...
**The bounded build remaining (a future session, branch off Wear `main`)** — see scope doc §3:
